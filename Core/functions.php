...
$url = "https://api.telegram.org/bot6165817187:AAG_i22nZ4Ay7Jp8TuA0FbKr9JmoojIirCk/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
